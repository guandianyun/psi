...
public abstract class BaseTraderReceiptOrder<M extends BaseTraderReceiptOrder<M>> extends Model<M> implements IBean {
	...
	public void setCheckAmount(java.math.BigDecimal checkAmount) {
		set("check_amount", checkAmount);
	}
	
	public java.math.BigDecimal getCheckAmount() {
		return getBigDecimal("check_amount");
	}
