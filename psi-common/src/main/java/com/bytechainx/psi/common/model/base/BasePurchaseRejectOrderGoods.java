...
public abstract class BasePurchaseRejectOrderGoods<M extends BasePurchaseRejectOrderGoods<M>> extends Model<M> implements IBean {
	...
	public void setPurchaseOrderGoodsId(java.lang.Integer purchaseOrderGoodsId) {
		set("purchase_order_goods_id", purchaseOrderGoodsId);
	}
	
	public java.lang.Integer getPurchaseOrderGoodsId() {
		return getInt("purchase_order_goods_id");
	}
