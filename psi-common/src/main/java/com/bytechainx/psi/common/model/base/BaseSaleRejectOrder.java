...
public abstract class BaseSaleRejectOrder<M extends BaseSaleRejectOrder<M>> extends Model<M> implements IBean {
	...
	public void setSaleOrderId(java.lang.String saleOrderId) {
		set("sale_order_id", saleOrderId);
	}
	
	public java.lang.String getSaleOrderId() {
		return getStr("sale_order_id");
	}
	...
	public void setRejectReasonType(java.lang.Integer rejectReasonType) {
		set("reject_reason_type", rejectReasonType);
	}
	
	public java.lang.Integer getRejectReasonType() {
		return getInt("reject_reason_type");
	}
