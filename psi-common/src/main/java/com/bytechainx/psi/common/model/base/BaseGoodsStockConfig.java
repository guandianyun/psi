...
public abstract class BaseGoodsStockConfig<M extends BaseGoodsStockConfig<M>> extends Model<M> implements IBean {
	...
	public void setLowStock(java.math.BigDecimal lowStock) {
		set("low_stock", lowStock);
	}
	
	public java.math.BigDecimal getLowStock() {
		return getBigDecimal("low_stock");
	}
	
	public void setHighStock(java.math.BigDecimal highStock) {
		set("high_stock", highStock);
	}
	
	public java.math.BigDecimal getHighStock() {
		return getBigDecimal("high_stock");
	}
	...
	public java.math.BigDecimal getSafeStock() {
		return getBigDecimal("safe_stock");
	}
