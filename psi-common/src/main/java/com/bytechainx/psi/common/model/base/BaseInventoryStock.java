...
public abstract class BaseInventoryStock<M extends BaseInventoryStock<M>> extends Model<M> implements IBean {
	...
	public void setInitStock(java.math.BigDecimal initStock) {
		set("init_stock", initStock);
	}
	
	public java.math.BigDecimal getInitStock() {
		return getBigDecimal("init_stock");
	}
	...
	public java.math.BigDecimal getLockStock() {
		return getBigDecimal("lock_stock");
	}
	
	public void setReserveStock(java.math.BigDecimal reserveStock) {
		set("reserve_stock", reserveStock);
	}
	
	public java.math.BigDecimal getReserveStock() {
		return getBigDecimal("reserve_stock");
	}
	
	public void setWarnType(java.lang.Integer warnType) {
		set("warn_type", warnType);
	}
	
	public java.lang.Integer getWarnType() {
		return getInt("warn_type");
	}
